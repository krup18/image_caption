...
def greedySearch(photo):
    ...
    for i in range(max_length):
        sequence1 = [wordtoix[w] for w in in_text.split() if w in wordtoix]
        sequence1 = pad_sequences([sequence1], maxlen=max_length)
...
for z in range(200,210):
    ...
    plt.imshow(x)
    plt.show()
    print("Caption:",greedySearch(img))
'''
...
image1=encode(test_image).reshape((1,2048))
#x=plt.imread(images+pic)
plt.imshow(im)
plt.show()
print(greedySearch(image1))
